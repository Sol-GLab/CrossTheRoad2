...
#define UE_PROJECT_NAME CrossTheRoad
#define UE_TARGET_NAME CrossTheRoadEditor
#define UE_MODULE_NAME "CrossTheRoad"
...
#define CROSSTHEROAD_API DLLEXPORT
